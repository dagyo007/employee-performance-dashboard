...
const DEMO_DATA = {
    ...
    sales: [
        ...
        ["하이마트", 1000, 800, 900, 1100, 110.0, 37.5, 22.2],
        ["전자랜드", 800, 700, 750, 850, 106.3, 21.4, 13.3],
        ["LG베스트샵", 1200, 1100, 1050, 1300, 108.3, 18.2, 23.8],
        ["삼성스토어", 1500, 1400, 1450, 1600, 106.7, 14.3, 10.3]
    ],
    salesBranch: [
        {
            manager1: "양판1담당",
