...
const DEMO_DATA = {
    ...
    sales: [
        ...
        ["인터비즈", 15621, 26404, 25329, 31363, 120.3, 18.8, 23.8],
        ["양판점", 5692, 15889, 20749, 21607, 158.7, 36.0, 4.1],
        ["양판1담당", 1105, 4523, 6394, 7292, 148.5, 61.2, 14.1],
        ["전자랜드", 5692, 5396, 6861, 9034, 158.7, 67.4, 31.7],
        ["서승호", 487, 450, 541, 755, 155.1, 67.7, 39.6],
        ["최수웅", 619, 591, 686, 886, 143.2, 49.9, 29.1],
        ["양판2담당", 2100, 4353, 5276, 4665, 140.9, 7.2, -11.6],
        ["김승원", 609, 652, 1042, 851, 139.6, 30.4, -18.3]
    ],
    salesBranch: [
        {
            manager1: "양판1담당",
